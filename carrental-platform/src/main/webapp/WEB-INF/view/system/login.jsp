...
<form class="layui-form" id="loginFrm" method="post" action="/car_rental/login/login">
    ...
    <div class="layui-form-item input-item" id="imgCode">
        ...
        <img src="/car_rental/login/getCode" onclick="this.src=this.src+'?'">
    </div>
    <div class="layui-form-item">
        <button class="layui-btn layui-block" lay-filter="login" lay-submit>登录</button>
    </div>
     <div class="layui-form-item">
        <input class="layui-btn layui-block" readonly lay-filter="register" onclick="javascript:register()" value="注册"> 
    </div>
...
function register(){
    	window.location.href="/car_rental/login/toRegister";
    }
</script>
</body>
</html>

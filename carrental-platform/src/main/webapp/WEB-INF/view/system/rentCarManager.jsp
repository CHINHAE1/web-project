    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function initCarData() {
            ...
            tableIns = table.render({
                ...
                , url: '/car_rental/car/queryCars?isrenting=0' //数据接口
                , title: '车辆列表'//数据导出来的标题
                , height: 'full-150'
                , page: true  //是否启用分页
                , cols: [[   //列表数据
        ...
        $("#doSearch").click(function () {
            ...
            $.post("/car_rental/rent/checkCustomerExist", params, function (obj) {
        ...
        function openRentCar(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    $.get("/car_rental/rent/initRentFromData",{
                        identity:identity,
                        price:price,
                        carnumber:carnumber
                    },function (obj) {
        ...
        form.on("submit(doSubmit)", function (obj) {
            ...
            $.post("/car_rental/rent/addRentinfo", params, function (obj) {
                layer.msg(obj.msg);
                //关闭弹出层

...
public class NewsServiceImpl implements NewsService {
    ...
    @Override
    public int addSelective(final NewsVo newsVo) {
        News news = new News();
        BeanUtils.copyProperties(newsVo, news);
        return newsMapper.addSelective(news);
    }

    @Override
    public int updateNewsById(final NewsVo newsVo) {
        News news = new News();
        BeanUtils.copyProperties(newsVo, news);
    ...
    @Override
    public int deleteNewsById(final Integer id) {
        return newsMapper.deleteNewsById(id);
    }

    @Override
    public void deleteBatchNewsByIds(Integer[] ids) {
        for (Integer id : ids) {
